...
import { useRcAddSingleJobPostMutation } from "../../../state/recruiter/post/api";
...
const employmentTypeOptions = Object.entries(EMPLOYMENT_TYPES).map(
  (employmentType) => {
    return {
...
// const validationSchema = Yup.object().shape({
//   title: Yup.string().max(32, "Title must be at most 32 characters long"),
//   description: Yup.string(),
//   designation: Yup.string(),
//   jobType: Yup.string(),
//   totalOpening: Yup.number(),
//   minimumExperience: Yup.number(),
//   maximumExperience: Yup.number(),
//   skills: Yup.array()
//     .of(Yup.string())
...
//     .of(Yup.object())
//     .min(1, "Please specify atleast one address"),
//   // city: Yup.array().of(Yup.string()).min(1, "Please specify atleast one city"),
//   // pincode: Yup.array()
//   //   .of(Yup.string())
//   //   .min(1, "Please specify atleast one pincode"),
...
const Index = () => {
  ...
  // Mutations
  const [rcCreateNewPost, { isLoading: isRcCreateNewPostLoading }] =
    useRcAddSingleJobPostMutation();

  /**
   * Handle create new job post
   */
  const handleCreateNewJobPost = async (values) => {
    try {
      ...
      if (pgDetails.length) {
        education.pg = graduationNotRequired ? null : pgDetails.join(",");
      }

      if (ppgDetails.length) {
        education.ppg = graduationNotRequired ? null : ppgDetails.join(",");
      }
      ...
      const response = await rcCreateNewPost(dataToCreate).unwrap();

      if (response.data) {
        navigate("/recruit/dashboard/jobs");
      }
    } catch (error) {
      const submitJobErrorMessage = error.data.message;
      setError(submitJobErrorMessage);
  ...
  return (
    <div className="position-relative">
      <h2 className="main-title">Post Job</h2>
      ...
      <div className="bg-white card-box border-20">
        ...
        <Formik
          ...
          onSubmit={handleCreateNewJobPost}
        >
          {({
            values,
            errors,
            ...
            <Form id="post-job-id" onSubmit={handleSubmit}>
              <Field name="title">
                {({ field }) => (
                  <FormControl
                    mb="30px"
                    ...
                    {({ field, form }) => (
                      ...
                      >
                        ...
                        <JBSelect
                          ...
                          selectedInput={values.employmentType}
                          styles={{
                            control: (baseStyles, state) => ({
                              ...baseStyles,
                              boxShadow:
              ...
              <div className="row align-items-end mb-30">
                ...
                <div className="col-md-6">
                  <Field name="totalOpening">
                    {({ field }) => (
                      <FormControl
                        isInvalid={errors.totalOpening && touched.totalOpening}
                        isRequired
                      >
                  ...
                  <Field name="minimumExperience">
                    {({ field }) => (
                      <FormControl
                        mb="30px"
                        isInvalid={
                          errors.minimumExperience && touched.minimumExperience
                        }
                        isRequired
                      >
                            ...
                            values.minimumExperience && [
                              {
                                ...
                                label: values.minimumExperience,
                              },
                            ]
                          }
                          styles={{
                  ...
                  <Field name="maximumExperience">
                    {({ field }) => (
                      <FormControl
                        mb="30px"
                        isInvalid={
                          errors.maximumExperience && touched.maximumExperience
                        }
                        isRequired
                      >
                            ...
                            values.maximumExperience && [
                              {
                                ...
                                label: values.maximumExperience,
                              },
                            ]
                          }
                          styles={{
                        ...
                        >
                              ...
                              {({ field }) => (
                                ...
                                >
                                  ...
                                  <AsyncSelectWithFetch
                                    ...
                                    taxonomy="city"
                                    selectedInput={values.location[index]?.city}
                                    styles={{
                                      control: (baseStyles, state) => ({
                                        ...baseStyles,
                                        boxShadow:
                              ...
                              {({ field }) => (
                                ...
                                >
                                  ...
                                  <AsyncSelectWithFetch
                                    ...
                                    onChange={(selectedOption) => {
                                      arrayHelpers.replace(index, {
                                        city: values.location[index]?.city,
                                        pincode: selectedOption.label, // parseInt
                                      });
                                    }}
                                  />
                                  <FormErrorMessage position="absolute">
                          ...
                          {addressDetails.length > 1 && (
                            <CloseButton
                              color="red"
                              onClick={() => {
                                const newLocation = [...addressDetails];
      ...
      <div className="button-group d-inline-flex align-items-center mt-30">
        <Button
          ...
          form="post-job-id"
          isLoading={isRcCreateNewPostLoading}
        >
          Save
        </Button>
        <NavLink
