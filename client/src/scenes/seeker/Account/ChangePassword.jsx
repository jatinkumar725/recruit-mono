...
import { useSkChangePasswordMutation } from "../../../state/seeker/profile/api";
import { setUpdateTimeStamp } from "../../../state/seeker/authentication/slice";
...
const ChangePassword = () => {
  ...
  // Mutations
  const [skChangePassword, { isLoading: isChangePasswordLoading }] =
  ...
  const handleChangePassword = async (values) => {
    try {
      ...
      const response = await skChangePassword(restValues).unwrap();
