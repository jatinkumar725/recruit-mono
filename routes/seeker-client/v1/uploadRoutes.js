...
router
  ...
  .post(
    auth(PLATFORM.SEEKER_CLIENT),
    // checkRolePermission,
    fileUploadController.uploadProfile
  );
router
...
router
  ...
  .get(
    auth(PLATFORM.SEEKER_CLIENT),
    // checkRolePermission,
    fileUploadController.getUploadedProfile
  );
router
  .route("/client/cloud-aggregator-sk/v1/:profileId/resume")
  .get(
    auth(PLATFORM.SEEKER_CLIENT),
    // checkRolePermission,
    fileUploadController.getUploadedResume
  );
...
router
  ...
  .delete(
    auth(PLATFORM.SEEKER_CLIENT),
    // checkRolePermission,
    fileUploadController.deleteUploadedProfile
  );
router
  .route("/client/cloud-aggregator-sk/v1/:profileId/resume")
  .delete(
    auth(PLATFORM.SEEKER_CLIENT),
    // checkRolePermission,
    fileUploadController.deleteUploadedResume
  );
