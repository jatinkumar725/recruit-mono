...
/**
 * Function used to delete file from local storage.
 * 
 * @param {string} filePath - The path of the file to be deleted.
 * @returns {object} { status, message }
 */
async function deleteFileFromLocalServer(filePath) {
  try {
...
module.exports = { uploadFilesOnLocalServer, deleteFileFromLocalServer, };