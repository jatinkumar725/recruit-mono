/**
 * getTermRelationshipCount.js
 */

const response = require('../../utils/response');
/**
 * @description : returns total number of records of termRelationship
 ...
 */
const getTermRelationshipCount = ({
  ...
  let count = await termRelationshipDb.count(where);
  return response.success({ data: { count } });
};
module.exports = getTermRelationshipCount;