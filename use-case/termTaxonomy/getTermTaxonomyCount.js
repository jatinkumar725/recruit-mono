/**
 * getTermTaxonomyCount.js
 */

const response = require('../../utils/response');
/**
 * @description : returns total number of records of termTaxonomy
...
const getTermTaxonomyCount = ({
  ...
  let count = await termTaxonomyDb.count(where);
  return response.success({ data: { count } });
};
module.exports = getTermTaxonomyCount;